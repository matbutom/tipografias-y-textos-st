...
# Directorios de entrada y salida específicos para tipografías serif
input_dir = Path('assets/tipografias/tipografias-serif')
output_dir = Path('recortes-tipografias-serif')
