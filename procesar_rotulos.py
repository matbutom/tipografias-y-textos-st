...
# Directorio de entrada y salida para tipografías rótulos
input_dir = Path('assets/tipografias/tipografias-rotulos')
output_dir = Path('recortes-tipografias-rotulos')
