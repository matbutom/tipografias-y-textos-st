...
# Directorio de entrada y salida para tipografías sans-serif
input_dir = Path('assets/tipografias/tipografias-sans-serif')
output_dir = Path('recortes-tipografias-sans-serif')
